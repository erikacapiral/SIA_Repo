        ...
        <x-app-layout>
            <x-slot name="header">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Folders') }} <span style="font-size: 15px; margin-left: 10px;"> Path: 4B/</span>
                </h2>
                ...
                <div class="card-header py-3 ">
                    <div class="btn-group">
                        <button type="button" class="btn mt-4"
                            ...
                            data-target="#uploadModal" aria-expanded="false">
                        ...
                        <table class="table  table-hover  " id="dataTable" width="100%" cellspacing="0"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><i class="fa-solid fa-file"></i> Sample File</td>
                                    <td>02 Jan 2023</td>
                                    <td>
